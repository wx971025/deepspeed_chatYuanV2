...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="1.3b",
        choices=("350m", "1.3b", "6.7b", "13b", "66b", "mpt-7b", "chatYuanV2", "chatYuanV2-Local"),
    ...
    parser.add_argument(
        ...
        type=str,
        default="single_gpu",
        choices=("single_gpu", "single_node", "multi_node", "other_language"),
